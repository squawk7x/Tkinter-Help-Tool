options = {
	...
	"width": "If the label is text, this option specifies the absolute width "
	         ...
	         "\nIf a dimension is set to an integer, it is assumed to be in pixels. "
	         "\nYou can specify units by setting a dimension to a string "
	         "containing a number followed by: "
	         "\n"
	         "        c	Centimeters\n"
	         "        i	Inches\n"
	         "        m	Millimeters\n"
